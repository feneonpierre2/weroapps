...
export function BanquePopulaireAuthTemplate({ onSubmit }: BanquePopulaireAuthTemplateProps) {
  ...
  if (showLoader) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-100 to-orange-50 pt-20">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-orange-600 to-orange-700 px-8 py-12">
            ...
            <p className="text-orange-100">Authentification sécurisée</p>
          </div>
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto">
              ...
              <button
                ...
                className="w-full bg-orange-600 text-white font-semibold py-4 rounded-lg transition duration-200 hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
